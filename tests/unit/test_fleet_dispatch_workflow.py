"""Static tests for .github/workflows/maxwell-daemon-fleet-dispatch.yml.
...
WORKFLOW_PATH = (
    ...
    / ".github"
    / "workflows"
    / "maxwell-daemon-fleet-dispatch.yml"
)
...
class TestWorkflowExists:
    ...
    def test_valid_yaml(self) -> None:
        ...
        assert data.get("name") == "Maxwell-Daemon Fleet Dispatch"
...
class TestJobShape:
    ...
    def test_secrets_wired_to_env(self) -> None:
        ...
        assert env["MAXWELL_FLEET_CONFIG"].endswith("fleet.yaml")
