...
class ActionService:
    ...
    def mark_reverted(self, action_id: str) -> Action:
        ...
        # Assuming we don't have ACTION_REVERTED event yet, we could just
        # not publish or add one. But wait, we don't have
        # EventKind.ACTION_REVERTED. Let's look at events.py if we need
        # to publish.
        return action
