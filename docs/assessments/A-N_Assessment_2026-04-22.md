# A-N Assessment - Maxwell-Daemon - 2026-04-22

Run time: 2026-04-22T08:02:52.5783419Z UTC
Sync status: synced
Sync notes: Already up to date.
From https://github.com/D-sorganization/Maxwell-Daemon
 * branch            codex/issue-286-task-graphs-first-slice -> FETCH_HEAD
...
- Reviewed 347 tracked files, including 253 code files, 130 test files, 5 CI files, 1 config/build files, and 56 docs/onboarding files.
...
- Evidence: `347 tracked first-party files`
...
- Evidence: `maxwell_daemon/api/server.py (1454 lines)`
- Evidence: `maxwell_daemon/api/ui/app.js (742 lines)`
- Evidence: `maxwell_daemon/backends/agent_loop.py (650 lines)`
- Evidence: `maxwell_daemon/daemon/runner.py (1208 lines)`
- Evidence: `maxwell_daemon/gh/executor.py (736 lines)`
- Evidence: `maxwell_daemon/gh/repo_schematic.py (584 lines)`
- Evidence: `tests/unit/test_api.py (540 lines)`
- Evidence: `maxwell_daemon/api/server.py (coarse avg 104 lines/definition)`
- Evidence: `maxwell_daemon/backends/agent_loop.py (coarse avg 108 lines/definition)`
- Evidence: `maxwell_daemon/backends/openai.py (coarse avg 82 lines/definition)`
...
- Evidence: `tests/unit/test_rbac.py`
...
- Severity: medium
- Problem: Oversized files found: maxwell_daemon/api/server.py (1454 lines); maxwell_daemon/api/ui/app.js (742 lines); maxwell_daemon/backends/agent_loop.py (650 lines); maxwell_daemon/daemon/runner.py (1208 lines); maxwell_daemon/gh/executor.py (736 lines); maxwell_daemon/gh/repo_schematic.py (584 lines); tests/unit/test_api.py (540 lines); tests/unit/test_backend_agent_loop.py (575 lines); tests/unit/test_daemon.py (589 lines); tests/unit/test_fleet_coordinator.py (584 lines); tests/unit/test_gh_client.py (701 lines); tests/unit/test_recipes.py (568 lines); tests/unit/test_repo_schematic.py (525 lines)
...
- Severity: high
- Problem: Potential secret-like assignments found in: tests/unit/test_api.py; tests/unit/test_backend_claude.py; tests/unit/test_github_auth.py; tests/unit/test_rbac.py
